...
#ifndef CONTACTS_SWIFT_H
#define CONTACTS_SWIFT_H
...
- (void)textFieldChange:(UITextField * _Nonnull)textField;
...
@property (nonatomic, copy) NSString * _Nullable avatarUrlString;
...
SWIFT_CLASS("_TtC8Contacts17ContactDetailView")
...
SWIFT_CLASS("_TtC8Contacts17DetailsActionView")
...
SWIFT_CLASS("_TtC8Contacts17HomeTableViewCell")
...
SWIFT_CLASS("_TtC8Contacts18HomeViewController")
@interface HomeViewController : UIViewController
- (nullable instancetype)initWithCoder:(NSCoder * _Nonnull)coder OBJC_DESIGNATED_INITIALIZER;
- (void)viewDidLoad;
- (void)userDidSelectAddButton;
- (nonnull instancetype)initWithNibName:(NSString * _Nullable)nibNameOrNil bundle:(NSBundle * _Nullable)nibBundleOrNil SWIFT_UNAVAILABLE;
@end
